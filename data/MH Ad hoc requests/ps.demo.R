...
neo.mr <- read_xlsx("data/June 2024 Ad Hoc/Neonatal mortality rate_Northern.xlsx")
names(neo.mr)
...
nmr_plt <- ggplot(neo.mr1, aes(x=yr, y=neonatal.mortRate, colour=usaid_red)) + 
  ...
  labs(x="", y="", caption="Data Source: HMIS", title="Neonatal Mortality Rate per 1,000 live births, Northern province districts (2018 - 2023).") +
  scale_color_manual(name ="",
                     values = usaid_red,
...
nmr_plt
ggsave("viz/Ad hoc Jun 2024/Neonata mortality rates_Northern districts.png",
       device="png",
       type="cairo",
       height = 6.5,
       width = 12)
