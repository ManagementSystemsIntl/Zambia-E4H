...
supps_plt <- ggplot(mat, aes(x = mnthyr, y = rate, group = subpop, colour = subpop)) +
  ...
  scale_y_continuous(limits = c(0,1),
                     ...
                     breaks = c(.1,.2,.3,.4,.5,.6,.7,.8,.9, 1)) +
  scale_x_date(date_labels="%b %y",date_breaks="3 months") +
  labs(x="", y="", caption="Data Source: HMIS", title="Coverage of Folic Acid and Iron Supplementation during ANC visits, Jan 2020 - Sept 2024.") +
  scale_color_manual(name ="",
                     values = usaid_palette,
...
ggplot(matmr2, aes(x=yr, y=mr)) +
  ...
  labs(x="", y="Mortality Ratio", caption="Data Source: HMIS",title="Maternal Mortality Ratio and Reporting rates - Jan 2020 to Sept 2024.") +
  scale_color_manual(name ="",
                     values = usaid_red,
...
full_plt <- ggplot(fullyimz1, aes(x = mnthyr, y = ficp, colour=usaid_blue )) +
  ...
  scale_y_continuous(limits = c(0,1),
                     ...
                     breaks = c(.1,.2,.3,.4,.5,.6,.7,.8,.9, 1)) +
  scale_x_date(date_labels="%b %y",date_breaks="3 months") +
  labs(x="", y="", caption="Data Source: HMIS", title="The proportion of infants that are fully immunized had a deep between Jan 2022 and Jan 2023, \nbut the upward trajectory into 2024 to levels above 85% is recommendable!") +
  scale_color_manual(name ="",
                     values = usaid_blue,
...
dptfull_plt <- ggplot(chldH, aes(x = mnthyr, y = rate, group = subpop, colour = subpop)) +
  ...
  scale_y_continuous(limits = c(0,1),
                     ...
                     breaks = c(.1,.2,.3,.4,.5,.6,.7,.8,.9, 1)) +
  scale_x_date(date_labels="%b %y",date_breaks="3 months") +
  labs(x="", y="", caption="Data Source: HMIS", title="Coverage of the Fully Immunized and DPT Under 1 (Jan 2020 - Sept 2024).") +
  scale_color_manual(name ="",
                     values = usaid_palette,
...
provdpt.imnzd_plt <- ggplot(fulldpt_prov, aes(x = mnthyr, y = rate, group = subpop, colour = subpop)) +
  ...
  scale_y_continuous(limits = c(0,1),
                     ...
                     breaks = c(.2,.4,.6,.8,1)) +
  labs(x ="", y="", caption = "Data Source: HMIS") +labs(x ="", y="", caption = "Data Source: HMIS") +
  ggtitle("The picture on Provincial Coverage of the Fully Immunized (%) and DPT 1st dose Under 1 (%) shows \na simillar pattern across provinces which is not different from the National picture (Jan 2020 - Sept 2024).") +
  facet_wrap(~prov, ncol=4) +
  faceted +
  scale_color_manual(name ="",
                     values = usaid_palette,
