...
#   "psych", "labelled","readxl", "skimr","sjlabelled","sjstats","sjPlot", "sjmisc","readr","ggrepel","openxlsx", "sysfonts","scales",
#   "magrittr","knitr","lubridate","Hmisc","haven","tidyr","reshape2","DescTools","extrafont", "patchwork", "extrafontdb", "ggtext", 
#   "geomtextpath","zoo","psych","cowplot","ztable","pheatmap", "RColorBrewer", "data.table", "d3heatmap","hablar", "gganimate", 
#   "dygraphs", "gapminder", "hrbrthemes","geomtextpath", "patchwork", "gridExtra", "grid", "rmarkdown", "forecast", "backtest", 
#   "quantmod", "tseries", "writexl", "ggpubr", "rcartocolor", "remotes", "geodata", "shiny", "rgeoboundaries", "nasapower", "leaflet", 
#   "ggsflabel", "sf", "RSelenium", "netstat")
...
usaid <- function(){
  ...
  list(
    ...
    , ggplot2::scale_fill_manual(values = rep(c("#BA0C2F", "#A7C6ED","#8C8985", "#002F6C","#212721", "#651D32", "#0067B9"), 2))
    , ggplot2::scale_color_manual(values = rep(c("#BA0C2F", "#A7C6ED","#8C8985", "#002F6C","#212721", "#651D32", "#0067B9"),2))
  )
}
