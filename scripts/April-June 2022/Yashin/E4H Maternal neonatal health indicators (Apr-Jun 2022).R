...
pnc48.Q3.alll <- read_xls("data/48 hrs postnatal/PNC 48hrs 3233 level.xls")
...
tab1(pnc48.Q3.90$level2, bar.values="percent", main = "Level of facilities meeting the standard of 90% of expected deliveries \nreceive PNC within 48 hours \n (N = 236)")
